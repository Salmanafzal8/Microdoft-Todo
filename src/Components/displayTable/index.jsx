...
function DisplayTable({ displayingData,Completed }) {
  return (
    <div>
              ...
              <td className="px-4 py-2">
                <div className="flex justify-between">
                  <div className="flex gap-2.5">
                    <button  onClick={() => Completed(index)} className="w-5 h-5 rounded-full bg-[#292929] hover:bg-[#343435] border border-white relative group">
