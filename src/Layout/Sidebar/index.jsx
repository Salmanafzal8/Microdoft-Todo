...
const Sidebar = () => {
  ...
  return (
    <div className="min-w-[20%] min-h-[100vh] bg-[#212121] text-amber-50 flex flex-col justify-between items-start px-2 pt-3 pb-0">
      <div className="flex flex-col gap-2.5 w-full">
        <div className="flex gap-2 justify-start items-start">
          ...
          <div>
            ...
            <p className="text-xs flex items-center text-[12px] z-40  gap-1">
              abdulhafeezafzal0@gmail.com
              <button
                onClick={() => setShowDropdown(!showDropdown)}
                className="px-1 py-0.5 rounded text-xs -space-y-1 text-[12px] z-40 cursor-pointer"
              >
                <IoIosArrowUp />
                <IoIosArrowDown />
              </button>
...
<div
  className={`absolute top-[60px] left-[16px] z-50 bg-[#212121] border text-[#bbbaba] rounded  min-w-[230px] flex flex-col text-sm overflow-hidden transition-all duration-300 ease-in transform origin-top ${
    showDropdown ? "scale-y-100 opacity-100 max-h-[500px]" : "scale-y-0 opacity-0 max-h-0"
  }`}
>
  <ul className="w-full">
    <li className="hover:bg-[#3d3d3d] text-[15px] opacity-75 py-[12px] px-3 border-b flex items-center gap-4 cursor-pointer">
      <MdManageAccounts />
      Manage Accounts
    </li>
    <li className="hover:bg-[#3d3d3d] text-[15px] opacity-75 py-[12px] px-3 border-b flex items-center gap-4 cursor-pointer">
    ...
    <li className="hover:bg-[#3d3d3d] text-[15px] opacity-75 py-[12px] px-3 flex items-center gap-4 cursor-pointer">
      <IoSyncSharp />
      Sync
    </li>
  </ul>
        ...
        <ul className="text-white flex flex-col items-start w-full">
          ...
          <li className="w-full">
            <button className="h-10 w-full flex justify-start items-center gap-4 text-[14px] hover:bg-gray-600 transition duration-150 rounded px-4">
              <MdStarOutline
                className="text-[20px] text-[#d39ea8]"
              />{" "}
              Important
            </button>
          </li>
